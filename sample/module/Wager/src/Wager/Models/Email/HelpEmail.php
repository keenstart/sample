...
class HelpEmail {
  ...
  protected $_ReplyEmail = 'help@thegamerwall.com';
  protected $_FromEmail = 'help@thegamerwall.com';
  protected $_ToEmail = 'help@thegamerwall.com';
  protected $_bouncedEmail = 'help@thegamerwall.com';

  
  public function sendEmail($question, $email) {
      ...
      $awsEmail->setEmailText($this->getEmailText($question, $email));
      $awsEmail->setEmailHtml($this->getEmailHtml($question, $email));
  ...
  protected function getEmailText($question, $email) {
      return $email . "\r\n\r\n" . $question . ".\r\n\r\nBest regards,\r\nThe Wager Wall";
  }
  
  protected function getEmailHtml($question, $email) {

      //Set the path to the view template.
      $resolver = new TemplateMapResolver();
      $resolver->setMap(array(
          'helpMailTemplate' => ROOT_PATH . '/module/Wager/view/emails/help.phtml'
      ));
