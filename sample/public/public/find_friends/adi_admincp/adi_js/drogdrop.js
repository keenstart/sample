			...
			var newList = {
				...
				dragStart: function(e) {
					...
					*/
					...
					/*var t = $('.adi_srvs_carrier').show();
					if(list.draggedItem.parents('.adi_on_services_out').length > 0) {
						$('.adi_on_services_out').append(t);
					}
					else {
						$('.adi_off_services_out').append(t);
					}
					t.append(list.draggedItem);
					list.draggedItem = t;*/
