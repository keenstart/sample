...
adiconts = adjq.extend({},adi.conts,{
	...
	gui: {adi:var (($adiinviter->settings['adiinviter_store_guest_user_info'] == 1 && $adiinviter->userid == 0) ? 1 : 0)},
});
...
adjq('#'+adipps.lg.ctarget).val('{adi:var $adi_output_contacts_list}');
adipps.lg.hide();
adi.call_event('contacts_dispatched', {});
