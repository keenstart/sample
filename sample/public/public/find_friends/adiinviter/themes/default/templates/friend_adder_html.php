...
<input type="hidden" name="adi_reg_ids" value="" class="adi_regids_input_pool">
...
<tr class="adi_clear_tr">
	...
	<td class="adi_clear_td" style="vertical-align:middle;">
		...
		<input type="submit" class="adi_button adi_pe_btn adi_skip_button" name="adi_skip_button" value="{adi:phrase fa_skip_button_txt}">

		{adi:if $adiinviter->friends_system && $adiinviter->userid !== 0}
			<input type="submit" name="adi_add_friend_button" class="adi_button adi_pe_btn adi_buttons_left_space adi_add_friend_button" value="{adi:phrase fa_add_as_friends_btn_txt}">
		{/adi:if}
		</div>
	</td>
</tr>
