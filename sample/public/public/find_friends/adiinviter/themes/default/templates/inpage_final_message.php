		...
		<div class="adi_nc_inpage_panel_outer">
			...
			<div class="adi_msg_btn_out">
				...
				{adi:if ($adiinviter->userid == 0)}
					<input type="submit" class="adi_button adi_ip_redirect adi_buttons_left_space" name="adi_website_register" value="{adi:phrase adi_register_btn_label}">
				{adi:else/}
					<input type="submit" class="adi_button adi_ip_redirect adi_buttons_left_space" name="adi_invite_history" value="{adi:phrase adi_invite_history_btn_label}">
				{/adi:if}
			</div>
		</div>
	</form>
