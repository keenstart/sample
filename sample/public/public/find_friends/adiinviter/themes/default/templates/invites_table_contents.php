...
<table class="adi_clear_table adi_invites_table" cellpadiing="0" cellspacing="0" width="100%" style="width:100%;">
	...
	{adi:else/}
		<td class="adi_clear_td adi_invites_table_head" style="padding-left:3px;padding-right:3px;vertical-align:middle;width: 70px;">{adi:phrase adi_ih_serial_number_column_text}</td>
	{/adi:if}

	{adi:if $adi_invite_history->ih_column_receiver_details}
